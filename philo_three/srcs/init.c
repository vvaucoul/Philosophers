...
/*   Updated: 2021/01/11 14:27:04 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		init_semaphores(t_prg *prg)
{
	...
	== SEM_FAILED)
		return (1);
	if ((prg->info.philo_state = sem_open(SEM_STATE, O_CREAT, 0644, 0))
	== SEM_FAILED)
		return (1);
	if ((prg->info.m_meal = sem_open(SEM_MEAL, O_CREAT, 0644, 0))
	== SEM_FAILED)
		return (1);
	if ((prg->info.global = sem_open(SEM_GLOBAL, O_CREAT, 0644, 0))
	== SEM_FAILED)
		return (1);
	return (0);
}
